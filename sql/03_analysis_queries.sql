...
--
--  The 13 analyses from the article "End-to-End HR Analytics with PostgreSQL",
--  in the same order and numbering. Each query is self-contained; run the
--  whole file or copy any single query.
--
--  Run:  psql -d hr_analytics -f sql/03_analysis_queries.sql
-- ============================================================================
